...
const FILES = [
  'SM_Env_PB_Hark_Level3_Wall_02.glb',
  'SM_Env_PB_Hark_Level3_Wall_03.glb',
  'SM_Env_PB_Hark_Level3_Wall_04.glb',
  'SM_Env_PB_Hark_Level3_Wall_05.glb',
  'SM_Env_PB_Hark_Level3_Wall_Half.glb',
  'SM_Env_PB_Hark_Level3_Window.glb',
  'SM_Env_PB_Hark_Level3_WindowGlass.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_R.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_R.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_Half_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_Half_R.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_Half_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_Half_R.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_Tall_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleBottom_Tall_R.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_Tall_L.glb',
  'SM_Env_PB_Hark_Level3_WallTriangleTop_Tall_R.glb',
];
